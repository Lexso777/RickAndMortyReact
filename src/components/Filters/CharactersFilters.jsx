...
const CharactersFilters = ({characterName, updateFilter, placeholder}) => {
    return (
        <>
            <Filter name={characterName} placeholder={placeholder} searchByName={(value) => updateFilter('name', value)}/>
